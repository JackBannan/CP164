...
class List:
    ...
    def clean(self):
        ...
        -------------------------------------------------------
        """
        for i in range(len(self._values),-1,-1):
            if self._values[i-1] in self._values[:i-1]:
...
class List:
    ...
    def _linear_search(self, key):
        ...
        while x<len(self._values) and i == -1:
            if key == self._values[x]:
                i = x
            x += 1
    ...
    def combine(self, source1, source2):
        ...
        while not source1.is_empty():
            self._values = self._values+[source1.pop(0)]
        
        while not source2.is_empty():
            self._values = self._values+[source2.pop(0)]
    ...
    def is_identical(self, target):
        ...
        # Your code here
        if len(self._values) == len(target):
            for x in range(0,len(self._valies)):
                if self._values[x] == target[x]:
                    count = count+1
    ...
    def split_alt(self):
        ...
        target1.append(value1)
        value2 = self._values.pop(0)
        target2.append(value2)
        # Your code here
