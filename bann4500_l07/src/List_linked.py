...
class List:
    ...
    def _linear_search(self, key):
        ...
        return previous,current_node,i
    ...
    def reverse_r(self):
        ...
        if n>1:
            self._swap(self._front,self._rear)
            self._next.reverse_r()
    ...
    def is_identical_r(self, other):
        ...
        if self._front._value != other._front._value:
            identical = False
        elif self._next._value != None:
            identical = self._next.is_identical_r(other._next)
    ...
    def _linear_search_r(self, key):
        ...
        if self._front._value == key:
            previous = None
            current = current_node._front
            index = 1
        elif self._rear._value == key:
            ...
            previous, current, index = self._next._linear_search_r(key)
