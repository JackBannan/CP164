"""
------------------------------------------------------
Sorted_List_linked module
------------------------------------------------------
Author: 
ID: 
Email: 
__updated__ = "2021-03-06"
------------------------------------------------------
"""
...
class Sorted_List:
    ...
    def __getitem__(self, i):
        ...
        if -self._count <= i < self._count:
            counter_alt = 0
            counter_main = -self._count
            
            current = self._front
            value = deepcopy(current._value)
            
            while counter_alt != i and counter_main != i:
    ...
    def clean(self):
        ...
        while current is not None:
            ...
            if previous is None or current._value != previous._value:
    ...
    def intersection(self, source1, source2):
        ...
        while source1_node is not None:
            ...
            _, currentent, _ = source2._linear_search(value)
            
            if currentent is not None:
                
                _, currentent, _ = self._linear_search(value)
                
                if currentent is None:
